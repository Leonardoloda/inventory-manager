    ...
    model {
        ...
        inventorySystem = softwareSystem "Inventory System" {
            ...
            DatabaseSystem = container "Database System" "Set of databases to store the data" {
                ...
                deliveryDatabase = component "Delivery Database" "Stores the deliveries that need to be done" "SQL" "database"
            }
            ...
            Backend = container "API application" "MicroService based application" "Kubernetes" {
                ...
                ordersService = component "Orders Service" "MicroService to handle orders" "API" "Microservice"
                stockService = component "Stock service" "Microservice to handle stock qty" "API" "Microservice"
                deliveryService = component "Delivery Service" "Microservice to handle deliveries" "API" "Microservice"
            }
            ...
            ReportStorage = container "Report application" "Consolidates system wide events into a report tool" "ELK" {
                ...
                collection = component "Data Storage" "Stores non structured events" "ElasticSearch" "database"

                terminal = component "Data Visualization" "Simple UI to visualize reports" "Kibana" "web"
            }
        }
        ...
        // Routes planning
        client -> gateway "Creates delivery order"
        gateway -> deliveryService "creates a new delivery order"
        deliveryService -> deliveryDatabase "Stores the new delivery order"
